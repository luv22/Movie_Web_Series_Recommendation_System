...
public class MovieDetails extends AppCompatActivity {
    ...
    private String URL = "https://api.themoviedb.org/3/search/movie?api_key=ba2ecc0718f461b1a96824d9a3623efd&query=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String inputValue  = obj.getStringExtra("Search");
...
//               intent.putExtra("Bitmap",byteArrayOutputStream.toByteArray());
               ...
               intent.putExtra("Rating",obje.getRateing().toString());
